  ...
  return <section id="learn-with-coach" className="mx-auto mt-5 max-w-4xl px-5">
    <div className="overflow-hidden rounded-3xl border border-violet-700/15 bg-[radial-gradient(circle_at_90%_10%,rgba(250,196,57,.28),transparent_30%),linear-gradient(135deg,#2d1d4a,#51376f)] p-5 text-cream-50 shadow-warm-lg sm:p-7">
      ...
      <div className="mt-6 rounded-2xl border border-sun-300/35 bg-sun-400/[.09] p-4">
        ...
        <p className="mt-2 text-xs text-cream-100/70">Type the exact thing you want to understand. Coach teaches that concept directly—no dropdown, parent-topic selection, or prerequisite screen.</p>
      </div>

      {topics.length > 0 && <details className="mt-4 rounded-2xl border border-white/15 bg-black/10 p-3"><summary className="cursor-pointer text-sm font-extrabold text-cream-50">Or teach a full syllabus topic</summary>
