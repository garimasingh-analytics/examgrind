        ...
        <div className="flex items-start gap-4 pr-16">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <Link href={`/guides?exam=${handoff.exam}`} onClick={() => { trackDiagnosisHandoffAction({ exam: handoff.exam as "cuet" | "ssc-cgl" | "neet-ug", action: "read_guide" }); window.localStorage.removeItem(HANDOFF_KEY); }} className="inline-flex rounded-2xl border border-cocoa-900/15 bg-cream-50 px-4 py-2.5 text-sm font-bold text-cocoa-900 hover:bg-cream-100">Read my study guide</Link>
            </div>
          </div>
        </div>
      </div>
