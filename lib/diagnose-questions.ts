...
export const DIAGNOSE_QUESTIONS: Record<DiagnoseExam, DiagnoseQuestion[]> = {
  ...
  "uppsc-pcs": [
    {
      id: "uppsc-pcs-q1",
      subjectId: "uppsc-pcs-polity-governance",
      ...
      drill: "UPPSC PCS Prelims · Indian Polity & Governance · Constitutional framework",
    ...
    {
      id: "uppsc-pcs-q2",
      subjectId: "uppsc-pcs-up-special",
      ...
      drill: "UPPSC PCS Prelims · Uttar Pradesh Special · Rivers and geography",
    ...
    {
      id: "uppsc-pcs-q3",
      subjectId: "uppsc-pcs-csat-skills",
      ...
      drill: "UPPSC PCS Prelims · CSAT Skills · Percentage change",
    ...
    },
    {
      ...
      drill: "UPPSC PCS Prelims · CSAT Skills · Statements and conclusions",
    ...
    },
    {
      ...
      drill: "UPPSC PCS Prelims · Indian Polity & Governance · Constitutional bodies",
